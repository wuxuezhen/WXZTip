 ...
 *  than the distance between  A and B. Radius of the first and the last waypoint in
 *  a mission does not affect the flight path and it should keep the default value
 *  (0.2m).
 */
